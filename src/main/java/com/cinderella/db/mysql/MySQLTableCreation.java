package main.java.com.cinderella.db.mysql;
...
//			User, Manager, Site, WashMachine, ReportDefect, Manage 
			...
			sql = "CREATE TABLE user (" + "Username VARCHAR(255) NOT NULL," + "password VARCHAR(255) NOT NULL," + "balance INT(9),"
			...
			sql = "INSERT INTO user VALUES('1111', '3229c1097c00d497a0fd282d586be050', '100', '1112223344', '20','hello@yahoo.com')";
			statement.executeUpdate(sql);
